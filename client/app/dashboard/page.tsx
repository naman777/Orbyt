...
function ZapTable({ zaps }: {zaps: Zap[]}) {
    ...
    return <div className="p-8 max-w-screen-lg w-full">
        ...
        {zaps.map(z => <div key={z.id} className="flex border-b border-t py-4">
            <div className="flex-1 flex"><img src={z.trigger.type.image} className="w-[30px] h-[30px]" /> {z.actions.map(x => <img src={x.type.image} key={x.actionId} className="w-[30px] h-[30px]" />)}</div>
